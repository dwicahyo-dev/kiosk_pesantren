    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            ...
            <a href="<?= site_url() ?>admin/animasi" class="brand-link bg-success">
                <img src="<?= base_url('assets/front/images/logo3.png') ?>" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2018 <a href="#">KIOSK PESANTREN</a>.</strong>
            All rights reserved.
