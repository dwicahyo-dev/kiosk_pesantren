...
<head>
    ...
    <title>Kios Informasi Pondok Pesantren Asy- Syifa</title>
    ...
    <style>
		...
		#image-section {
		    ...
		    background-image: url('<?= base_url('assets/front/banner2.jpeg')?>');
		    padding: 16px;
		}
...
<body>
    ...
    <nav class="navbar navbar-dark bg-success">
        <a class="navbar-brand" href="<?= base_url();?>">
            <img style="width: 70px; display: inline;margin-right: 20px;" src="<?= base_url('assets/front/images/logo3.png')?>" alt="">KIOS INFORMASI PONDOK PESANTREN ASY-SYIFAA KAJEN
        </a>
    </nav>
    <!-- End Navigation -->
