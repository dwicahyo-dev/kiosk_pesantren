...
<head>
    ...
    <title><?= $title ?> | Kios Informasi Pondok Pesantren Asy-Syifa Kajen</title>
...
<body class="theme-green">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= base_url();?>">
                    <img style="width: 50px; display: inline;margin-right: 20px;margin-top: -15px" src="<?= base_url('assets/front/images/logo3.png')?>" alt="">KIOS INFORMASI PONDOK PESANTREN ASY-SYIFAA KAJEN
                </a>
            </div>
        </div>
    </nav>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2019 <a href="javascript:void(0);">Rupidha Nur Indah Sari</a>.
                </div>
            </div>
            <!-- #Footer -->
        </aside>
